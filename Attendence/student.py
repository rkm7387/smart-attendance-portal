...
def show_student_panel():
    ...
    if not class_list:
        st.warning("No classrooms are currently open for attnedance.")
        st.stop()
    ...
    if not roll_number_raw:
        st.info("Please enter you roll number to contiue.")
        return
    ...
    if st.button("Submit Attendance"):
        ...
        try:
            ...
            attendance_count = attendance_today_respose.count or 0
